...
import { MineralUsesService } from './mineral-uses.service';
...
@Component({
  ...
  templateUrl: './mineral-uses.component.html',
  styleUrls: ['./mineral-uses.component.css']
})
export class MineralUsesComponent implements OnInit {
  editable: boolean;
...
openModal(modal) {
  ...
  gettype(){
    this.MineralUsesService.getsite().subscribe(
      (response:any) => {
        this.types = response;
  ...
  getmineralUse() {
    this.MineralUsesService.getmineralUse().subscribe(
      (response) => {
  ...
  select() {
    console.log('Select');
    this.MineralUsesService.DisplayCoordinate = false;
  }
  getresourceId() {
    this.MineralUsesService.getresourceId().subscribe(
      (response) => {
  ...
  getCustomer_ID(){
    this.MineralUsesService.getCustomer_ID().subscribe(
      (response:any) => {
    ...
    getgisplotID(){
    this.MineralUsesService.getgisplotID().subscribe(
        (response) => {
   ...
   public OnClickMap(event) {   
    ...
    deletemineralUse(mineralUses) {
      if (confirm("Are you sure you want to delete?  !!!"))
        this.MineralUsesService.deletemineralUse(mineralUses)
          .subscribe(
            (response) => {
              this.getmineralUse();
